...
* **SORTING**
![sort 1](https://user-images.githubusercontent.com/125839542/230770941-90e817e2-de96-4767-aaf2-899d859d9837.png)
...
![sort](https://user-images.githubusercontent.com/125839542/230770919-2760fbc7-a13b-4249-8971-6a2f6ecd1658.png)
...
* Pertama adalah fitur tampilkan data, yang dapat digunakan oleh admin untuk menampilkan data yang ada. 
* Kedua, fitur mengurutkan jadwal, digunakan oleh admin untuk melihat data sesuai dengan urutan yang diinginkan. Contohnya seperti menampilkan data sesuai urutan dari tabel jam secara ascending. 
* Ketiga, fitur mencari tujuan, digunakan oleh admin untuk mencari kota tujuan yang ada.
* Keempat, fitur tambahkan data di awal, digunakan oleh admin untuk menambahkan data di awal. 
* Kelima, fitur tambahkan data di akhir, digunakan oleh admin untuk menambahkan data di akhir. 
* Keenam, fitur perbaiki data, digunakan oleh admin untuk memperbaiki data jika ada data yang salah atau jika memang ingin memperbarui data yang sudah ada. 
* Ketujuh, fitur hapus data, digunakan oleh admin untuk menghapus data yang ada. 
* Kedelapan, fitur histori, digunakan oleh admin untuk melihat riwayat aktifitas yang dilakukan oleh admin ketika menambahkan, menghapus, dan memperbarui data.
* Kesembilan, fitur keluar, digunakan oleh admin untuk keluar dari program.

#### Pada bagian pengunjung, hanya terdapat 4 fitur. 
* Yang pertama adalah fitur tampilkan data, digunakan oleh pengunjung untuk melihat jadwal keberangkatan Kereta Api yang tersedia. 
...
* Ketiga, fitur mencari tujuan, digunakan oleh pengunjung untuk mencari kota tujuan.
